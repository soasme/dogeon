...
class DSONEncoder(object):
    ...
    def iterencode(self, o, _one_shot=False):
        ...
        def floatstr(o, allow_nan=self.allow_nan,
            ...
            text = text.replace('e', 'very')
            return text


        _iterencode = _make_iterencode(
                markers, self.default, _encoder, self.indent, floatstr,
                self.key_separator, self.item_separator, self.dict_item_seperator,
                self.sort_keys, self.skipkeys, _one_shot)
        return _iterencode(o, 0)

def _make_iterencode(markers, _default, _encoder, _indent, _floatstr,
        _key_separator, _item_separator, _dict_item_separator, _sort_keys, _skipkeys, _one_shot,
